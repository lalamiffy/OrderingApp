...
export default function OrderScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.head1}>Current Order Detail:</Text>
      <ScrollView
...
const styles = StyleSheet.create({
  ...
  ordercard: {
    ...
    borderRadius: 10,
    //elevation: 10,
    //boxShadowdow: "2px 2px 10px #888888", //web use
  },
  orderindex: {
    fontSize: 20,
    color: colors.col1,
  ...
  order: {
    ...
    elevation: 10,
    elevation: 10,
    ////boxShadowdow: "2px 2px 5px #888888", //web use
